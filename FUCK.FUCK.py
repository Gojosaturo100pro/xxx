...
os.system('xdg-open https://www.facebook.com/profile.php?id=61557119633109&mibextid=ZbWKwL)
...
class Main:
    ...
    def __init__(self):
        ...
        print(" [01] RANDOM  NUMBER CLONE \033[1;34m[ULTRA WORKING Tested By GOJO]")
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        ...
        for ps in pwx:
            ...
            sys.stdout.write('\r[\033[1;92mGS\033[1;97m] > [%s/%s] > [OK\033[1;97m:-\033[1;92m%s\033[1;97m] - [CP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
